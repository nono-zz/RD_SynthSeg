...
utils.save_volume(im, brain_generator.aff, brain_generator.header, '/home/zhaoxiang/SynthSeg/scripts/tutorials/outputs_tutorial_1/image.nii.gz')
utils.save_volume(lab, brain_generator.aff, brain_generator.header, '/home/zhaoxiang/SynthSeg/scripts/tutorials/outputs_tutorial_1/labels.nii.gz')
